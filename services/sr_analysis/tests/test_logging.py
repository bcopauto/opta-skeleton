...
def test_configure_logging_sets_json_renderer() -> None:
    ...
    from analysis_service.logging import configure_logging, get_logger
    configure_logging()
...
def test_bind_correlation_id_generates_uuid() -> None:
    ...
    from analysis_service.logging import bind_correlation_id, configure_logging, get_logger
    configure_logging()
